  ...
  <v-container fluid>
    <v-row align="center" justify="center">
      <v-col cols="12" sm="8" md="4">
        ...
        <v-card flat color="#b5525c" class="mt-10" dark>
          ...
          <v-container>
            ...
            >
              ...
              <v-text-field
                filled label="Email" required
                v-model="email" :rules="emailRules"
              ></v-text-field>
              <v-text-field
                filled label="Password"
                :type="show1 ? 'text' : 'password'" :append-icon="show1 ? 'mdi-eye-outline' : 'mdi-eye-off-outline'"
                @click:append="show1 = !show1" v-model="password" required :rules="passwordRules"
              ></v-text-field>
              <v-text-field
                filled label="Confirm password"
                :type="show2 ? 'text' : 'password'" :append-icon="show2 ? 'mdi-eye-outline' : 'mdi-eye-off-outline'"
                :rules="[() => !!passConfirm || 'Confirmation password is required']"
                @click:append="show2 = !show2" v-model="passConfirm" required
              ...
              <v-layout>
                <v-btn
                  block
                  color="#45454d"
                  :loading="loading" :disabled="loading || !isFormValid" @click="handleSignupUser"
                >
                  Sign up
